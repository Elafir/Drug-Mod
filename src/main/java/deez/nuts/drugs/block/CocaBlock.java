...
import deez.nuts.drugs.DrugsModElements;

@DrugsModElements.ModElement.Tag
public class CocaBlock extends DrugsModElements.ModElement {
	@ObjectHolder("drugs:coca")
	public static final Block block = null;

	public CocaBlock(DrugsModElements instance) {
		super(instance, 2);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("coca"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("drugs:coca"), configuredFeature);
		}
	}
